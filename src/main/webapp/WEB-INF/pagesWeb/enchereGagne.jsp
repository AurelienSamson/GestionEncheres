	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<label class="col-lg-8"></label><br><br>
				<label class="offset-lg-1 col-lg-1">Tel : </label>
				<label class=" col-lg-8"></label><br><br><br>
				<input class="offset-lg-1 col-lg-2" type="button" id="return_button_enchere" value="Back">
			</div>
		</div>
	</div>
